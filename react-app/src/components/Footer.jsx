/**
 * Footer — site footer with Instagram, payment methods and copyright.
 */

import { useLanguage } from '../context/LanguageContext';

/* Payment method icons (inline SVG — Visa & Mastercard style) */
...
function MastercardIcon({ className }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <circle cx="9" cy="12" r="8" opacity="0.9" />
      <circle cx="15" cy="12" r="8" opacity="0.6" />
    </svg>
  );
}
      ...
      <div className="footer-top">
        ...
        <div className="footer-col footer-col-payment">
          ...
          <div className="footer-payment">
            <span className="footer-payment-item" title="Visa" aria-hidden="true">
              <VisaIcon className="footer-payment-icon footer-payment-icon-visa" />
            </span>
            <span className="footer-payment-item" title="Mastercard" aria-hidden="true">
              <MastercardIcon className="footer-payment-icon footer-payment-icon-mastercard" />
            </span>
            <span className="footer-payment-item footer-payment-cod" title={t('footer.payOnDelivery')}>
